...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   for(let i = 0; i < arrayOfNums.length; i++){
      if(arrayOfNums[0] > arrayOfNums[1] && arrayOfNums[0] > arrayOfNums[2]){
         return arrayOfNums[0];
      }else if(arrayOfNums[1] > arrayOfNums[0] && arrayOfNums[1] > arrayOfNums[2]){
         return arrayOfNums[1];
      }else{
         return arrayOfNums[2];
      }
   }
}
...
function mayorACien(array) {
   ...
   // Tu código:
   const arrayMayorACien = [];
   for(let i = 0; i < array.length; i++){
      const element = array[i];

      if(element > 100){
         arrayMayorACien.push(element);
      }
   }
